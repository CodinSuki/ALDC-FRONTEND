    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <section className="pt-20 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold text-slate-900 mb-6">Resources & Guides</h1>
            ...
            {resources.map((resource, index) => {
              ...
              return (
                <Card key={index} className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
                  ...
                  <a href={resource.link} className="text-blue-600 hover:text-blue-700 font-semibold text-sm">
                    Learn More →
                  </a>
                </Card>
              );
      ...
      {/* CTA Section */}
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto text-center bg-blue-600 rounded-lg p-12 text-white">
